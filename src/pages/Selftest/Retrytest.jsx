...
import ReQuestion from './ReQuestion';
import ReResultmodal from './ReResultmodal';
...
const Retrytest = () => {
  ...
  const calculateScore = async () => {
    ...
    //제출
    try {
      const response = await axiosInstance.post('/with/mypage/survey/', surveyData);
  ...
  return (
    <Container>
      ...
      {showResult && <ReResultmodal score={score} />}
    </Container>
  );
};
